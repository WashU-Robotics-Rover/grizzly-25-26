...
static const _PerceptionState_type_support_symbol_names_t _PerceptionState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grizzly_interfaces, msg, PerceptionState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, grizzly_interfaces, msg, PerceptionState)),
  }
};
...
{
  return &::grizzly_interfaces::msg::rosidl_typesupport_cpp::PerceptionState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, grizzly_interfaces, msg, PerceptionState)() {
  return get_message_type_support_handle<grizzly_interfaces::msg::PerceptionState>();
}
