...
bool grizzly_interfaces__msg__perception_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("grizzly_interfaces.msg._perception_state.PerceptionState", full_classname_dest, 56) == 0);
  }
  grizzly_interfaces__msg__PerceptionState * ros_message = _ros_message;
  {  // header
  ...
  {  // terrain_class
    PyObject * field = PyObject_GetAttrString(_pymsg, "terrain_class");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->terrain_class = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PerceptionState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("grizzly_interfaces.msg._perception_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PerceptionState");
  ...
  {  // terrain_class
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->terrain_class);
    {
      int rc = PyObject_SetAttrString(_pymessage, "terrain_class", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
