...
#include "grizzly_interfaces/msg/detail/perception_state__rosidl_typesupport_fastrtps_c.h"
...
#include "grizzly_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_grizzly_interfaces
...
using _PerceptionState__ros_msg_type = grizzly_interfaces__msg__PerceptionState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PerceptionState__ros_msg_type * ros_message = static_cast<const _PerceptionState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PerceptionState__ros_msg_type * ros_message = static_cast<_PerceptionState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_grizzly_interfaces
size_t get_serialized_size_grizzly_interfaces__msg__PerceptionState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PerceptionState__ros_msg_type * ros_message = static_cast<const _PerceptionState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PerceptionState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_grizzly_interfaces__msg__PerceptionState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_grizzly_interfaces
size_t max_serialized_size_grizzly_interfaces__msg__PerceptionState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = grizzly_interfaces__msg__PerceptionState;
    is_plain =
      (
...
static size_t _PerceptionState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_grizzly_interfaces__msg__PerceptionState(
...
static message_type_support_callbacks_t __callbacks_PerceptionState = {
...
static rosidl_message_type_support_t _PerceptionState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PerceptionState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, grizzly_interfaces, msg, PerceptionState)() {
  return &_PerceptionState__type_support;
}
